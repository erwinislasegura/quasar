<section class="hero-strip">
  <div class="hero-copy"><small>Administración del sistema</small><h2>Configuración de servicios</h2><p>Estado de la base de datos, recepción del lector Windows y archivo local.</p></div>
